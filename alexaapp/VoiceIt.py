...
class VoiceIt:
    ...
    def authentication(self, mail, passwd, pathToAuthenticationWav, confidence, contentLanguage=""):
        email = mail
        password = self.getSHA256(passwd)
    ...
    def authenticationByWavURL(self, mail, passwd, urlToAuthenticationWav, confidence, contentLanguage=""):
        email = mail
        password = self.getSHA256(passwd)
